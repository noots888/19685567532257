// myMap service worker · mymap-v3-1-239_asset_crossing_markers
// Simple shell controller: no heavy install pre-cache. Shell files are cached only after they load successfully.
const MYMAP_SW_VERSION = 'mymap-v3-1-239_asset_crossing_markers';
const SHELL_CACHE = 'app-shell-' + MYMAP_SW_VERSION;
const OLD_CACHE_PATTERNS = [/^field-map-/i, /^fieldMap/i, /^myMap/i, /^mymap/i, /^app-shell-(?!mymap-v3-1-239_asset_crossing_markers$)/i];
